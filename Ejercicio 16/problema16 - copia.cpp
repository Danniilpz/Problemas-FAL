...
// El algoritmo recorre el array de numeros y tiene dos variables indicando la proxima posicion par e impar, 
//y va colocando los numeros en cada iteracion.

// Coste del algoritmo utilizado
// El coste es lineal de orden n datos, exactamente 4+6n
